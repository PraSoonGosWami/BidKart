...
public class PendingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //---------------Recycler View------------------------------------------
        pending_rView = view.findViewById(R.id.pending_rView);
        productListAdapter = new ProductListAdapter(productList, getContext());
        pending_rView.setLayoutManager(new LinearLayoutManager(getContext()));
        pending_rView.setAdapter(productListAdapter);
        pending_error = view.findViewById(R.id.pending_error);
        pending_error.setVisibility(View.GONE);
        //-----------------------------------------------------------------------
