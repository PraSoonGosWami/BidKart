...
public class MyBidsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //---------------Recycler View------------------------------------------
        mybid_recyclerview = view.findViewById(R.id.mybid_recyclerview);
        productListAdapter = new ProductListAdapter(productList, getContext());
        mybid_recyclerview.setLayoutManager(new LinearLayoutManager(getContext()));
        mybid_recyclerview.setAdapter(productListAdapter);
        mybid_error = view.findViewById(R.id.mybid_error);
        mybid_error.setVisibility(View.GONE);
        //-----------------------------------------------------------------------
    ...
    public void getMyBidProduct(String uid) {
                        ...
                        if (dataSnapshot.exists()) {
                            for (DataSnapshot data : dataSnapshot.getChildren()) {
                                ...
                                if (products.getpStatus().equals("pending"))
                                    continue;
                                if (products.getpBid().containsKey(uid)) {
